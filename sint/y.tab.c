...
{
  "$end", "error", "$undefined", "COMMA", "SINGLE_QUOTES", "SEMI_COLON",
  "ASSIGN", "BRACKET_OPEN", "BRACKET_CLOSE", "CURLY_BRACE_OPEN",
  "CURLY_BRACE_CLOSE", "BIG_BRACKET_OPEN", "BIG_BRACKET_CLOSE", "ADDOP",
  "RELOP", "MULOP", "IDENTIFIER", "INTEGER_C", "REAL_C", "CHAR_C",
  "BOOL_C", "$accept", "program", "expr", "simple_expr", "term",
...
{
      -7,    -7,   -13,   -13,   -13,   -13,   -13,     3,   -13,   -12,
     -11,   -13,   -13,   -13,    -3,   -13,    -7,    -7,    -7,   -13,
     -11,    -6,   -13
};
...
{
       0,     0,    10,    13,    14,    15,    16,     0,     2,     3,
       5,     7,     9,    11,     0,     1,     0,     0,     0,    12,
       6,     4,     8
};
...
{
       1,    16,    17,    15,    18,    19,    14,    16,    21,     2,
       3,     4,     5,     6,    20,     0,     0,    22
};

static const yytype_int8 yycheck[] =
{
       7,    13,    14,     0,    15,     8,     1,    13,    17,    16,
      17,    18,    19,    20,    16,    -1,    -1,    18
};
...
{
       0,     7,    16,    17,    18,    19,    20,    22,    23,    24,
      25,    26,    27,    28,    23,     0,    13,    14,    15,     8,
      25,    24,    26
};
